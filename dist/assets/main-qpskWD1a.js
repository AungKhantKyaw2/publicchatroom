 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge="WebChannelConnection";class ky extends by{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,t,r,s,o){const a=Ui();return new Promise(((u,h)=>{const d=new ul;d.setWithCredentials(!0),d.listenOnce(ll.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case zr.NO_ERROR:const y=d.getResponseJson();D(ge,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(y)),u(y);break;case zr.TIMEOUT:D(ge,`RPC '${e}' ${a} timed out`),h(new N(S.DEADLINE_EXCEEDED,"Request time out"));break;case zr.HTTP_ERROR:const A=d.getStatus();if(D(ge,`RPC '${e}' ${a} failed with status:`,A,"response text:",d.getResponseText()),A>0){let C=d.getResponseJson();Array.isArray(C)&&(C=C[0]);const k=C?.error;if(k&&k.status&&k.message){const O=(function(z){const W=z.toLowerCase().replace(/_/g,"-");return Object.values(S).indexOf(W)>=0?W:S.UNKNOWN})(k.status);h(new N(O,k.message))}else h(new N(S.UNKNOWN,"Server responded with status "+d.getStatus()))}else h(new N(S.UNAVAILABLE,"Connection failed."));break;default:x(9055,{l_:e,streamId:a,h_:d.getLastErrorCode(),P_:d.getLastError()})}}finally{D(ge,`RPC '${e}' ${a} completed.`)}}));const p=JSON.stringify(s);D(ge,`RPC '${e}' ${a} sending request:`,s),d.send(t,"POST",p,r,15)}))}T_(e,t,r){const s=Ui(),o=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=fl(),u=dl(),h={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(h.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(h.useFetchStreams=!0),this.jo(h.initMessageHeaders,t,r),h.encodeInitMessageHeaders=!0;const p=o.join("");D(ge,`Creating RPC '${e}' stream ${s}: ${p}`,h);const y=a.createWebChannel(p,h);this.I_(y);let A=!1,C=!1;const k=new Vy({Yo:V=>{C?D(ge,`Not sending because RPC '${e}' stream ${s} is closed:`,V):(A||(D(ge,`Opening RPC '${e}' stream ${s} transport.`),y.open(),A=!0),D(ge,`RPC '${e}' stream ${s} sending:`,V),y.send(V))},Zo:()=>y.close()}),O=(V,z,W)=>{V.listen(z,(G=>{try{W(G)}catch(Te){setTimeout((()=>{throw Te}),0)}}))};return O(y,$n.EventType.OPEN,(()=>{C||(D(ge,`RPC '${e}' stream ${s} transport opened.`),k.o_())})),O(y,$n.EventType.CLOSE,(()=>{C||(C=!0,D(ge,`RPC '${e}' stream ${s} transport closed`),k.a_(),this.E_(y))})),O(y,$n.EventType.ERROR,(V=>{C||(C=!0,ln(ge,`RPC '${e}' stream ${s} transport errored. Name:`,V.name,"Message:",V.message),k.a_(new N(S.UNAVAILABLE,"The operation could not be completed")))})),O(y,$n.EventType.MESSAGE,(V=>{if(!C){const z=V.data[0];K(!!z,16349);const W=z,G=W?.error||W[0]?.error;if(G){D(ge,`RPC '${e}' stream ${s} received error:`,G);const Te=G.status;let ve=(function(m){const _=ne[m];if(_!==void 0)return Gl(_)})(Te),ce=G.message;ve===void 0&&(ve=S.INTERNAL,ce="Unknown error status: "+Te+" with message "+G.message),C=!0,k.a_(new N(ve,ce)),y.close()}else D(ge,`RPC '${e}' stream ${s} received:`,z),k.u_(z)}})),O(u,hl.STAT_EVENT,(V=>{V.stat===Ri.PROXY?D(ge,`RPC '${e}' stream ${s} detected buffering proxy`):V.stat===Ri.NOPROXY&&D(ge,`RPC '${e}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{k.__()}),0),k}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((t=>t===e))}}function mi(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vo{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new N(S.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new de(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
